          ...
          <div className="ui active modal" >
            ...
            <div className="image content">
              ...
              <div className="description">
                ...
                <p>This project is a fully function email inbox built with React.js, JavaScript, and Bootstrap called <a href="https://email-inbox-react.firebaseapp.com/" target="_blank" rel="noopener noreferrer">React Inbox.</a> The site is responsive, mobile friendly, and runs flawlessly. **Please allow about 7 seconds for the dynamically populated messages to load from the Heroku database.** </p>
